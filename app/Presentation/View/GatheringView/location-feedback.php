...
const locationFeedbackInput = document.getElementById('location');
...
locationFeedbackInput.addEventListener('input', function() {
...
postBtn.addEventListener('click', function() {
  if (locationFeedbackInput.value.trim() !== '' && locationFeedbackInput.value.length <= 500) {
