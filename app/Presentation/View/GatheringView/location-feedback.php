...
<div class="container-fluid my-5 mb-5 mt-1">
  ...
  <div class="d-flex mb-4 align-items-center border-bottom border-2 px-2 py-3">
    ...
    <div class="col-8 text-center">
      <h2 class="fw-bold mb-0 h5">Location Feedback</h2>
    </div>
    <div class="col-2"></div>
  </div>

  <!-- Feedback List -->
  <div id="feedbackContainer" style="width: 100%; max-width: 1000px; margin: 0 auto; min-height:100vh; overflow-y: auto; padding: 10px 20px;">
