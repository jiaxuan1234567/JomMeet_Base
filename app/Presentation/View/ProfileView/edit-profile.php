...
$hobbyOptions = [
  'Basketball','Badminton','Hiking','Singing','Photography',
  'Reading','Jogging','Camping','Traveling','Swimming',
  'Yoga','Meditation','Drawing','Painting','Squash','Gym'
];
...
$(function(){
  ...
  $cancel.on('click', function(){
    ...
    $about.val(init.about_me); updAbout();
